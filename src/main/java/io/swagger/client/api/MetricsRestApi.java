...
public class MetricsRestApi {
    ...
    public MetricsRestApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call getStatusCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/metrics/status";
     ...
     * 
     * 
     * @return JsonRangerMetrics
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public JsonRangerMetrics getStatus() throws ApiException {
        ApiResponse<JsonRangerMetrics> resp = getStatusWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * 
     * @return ApiResponse&lt;JsonRangerMetrics&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<JsonRangerMetrics> getStatusWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getStatusValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<JsonRangerMetrics>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getStatusAsync(final ApiCallback<JsonRangerMetrics> callback) throws ApiException {
