...
public class JsonXXGroupUser extends JsonXXDBBase {
  @SerializedName("id")
  ...
  public JsonXXGroupUser id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public JsonXXGroupUser myClassType(Integer myClassType) {
  ...
  **/
  ...
  public JsonXXGroupUser myDisplayValue(String myDisplayValue) {
  ...
  **/
  ...
  public JsonXXGroupUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public JsonXXGroupUser parentGroupId(BigDecimal parentGroupId) {
  ...
  **/
  ...
  public JsonXXGroupUser userId(BigDecimal userId) {
    this.userId = userId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JsonXXGroupUser jsonXXGroupUser = (JsonXXGroupUser) o;
    return Objects.equals(this.id, jsonXXGroupUser.id) &&
        Objects.equals(this.myClassType, jsonXXGroupUser.myClassType) &&
        Objects.equals(this.myDisplayValue, jsonXXGroupUser.myDisplayValue) &&
        Objects.equals(this.name, jsonXXGroupUser.name) &&
        Objects.equals(this.parentGroupId, jsonXXGroupUser.parentGroupId) &&
        Objects.equals(this.userId, jsonXXGroupUser.userId) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, myClassType, myDisplayValue, name, parentGroupId, userId, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonXXGroupUser {\n");
