...
public class JsonXXContextEnricherDef extends JsonXXDBBase {
  @SerializedName("id")
  ...
  public JsonXXContextEnricherDef id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public JsonXXContextEnricherDef itemId(BigDecimal itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  **/
  ...
  public JsonXXContextEnricherDef defid(BigDecimal defid) {
    this.defid = defid;
    return this;
  }
  ...
  **/
  ...
  public JsonXXContextEnricherDef name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public JsonXXContextEnricherDef enricher(String enricher) {
  ...
  **/
  ...
  public JsonXXContextEnricherDef enricherOptions(String enricherOptions) {
  ...
  **/
  ...
  public JsonXXContextEnricherDef order(BigDecimal order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JsonXXContextEnricherDef jsonXXContextEnricherDef = (JsonXXContextEnricherDef) o;
    return Objects.equals(this.id, jsonXXContextEnricherDef.id) &&
        Objects.equals(this.itemId, jsonXXContextEnricherDef.itemId) &&
        Objects.equals(this.defid, jsonXXContextEnricherDef.defid) &&
        Objects.equals(this.name, jsonXXContextEnricherDef.name) &&
        Objects.equals(this.enricher, jsonXXContextEnricherDef.enricher) &&
        Objects.equals(this.enricherOptions, jsonXXContextEnricherDef.enricherOptions) &&
        Objects.equals(this.order, jsonXXContextEnricherDef.order) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, itemId, defid, name, enricher, enricherOptions, order, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonXXContextEnricherDef {\n");
